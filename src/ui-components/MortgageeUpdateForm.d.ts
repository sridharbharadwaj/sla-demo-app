...
export declare type MortgageeUpdateFormInputValues = {
    coRegNo?: string;
    name?: string;
    citizenship?: string;
...
export declare type MortgageeUpdateFormOverridesProps = {
    MortgageeUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type MortgageeUpdateFormProps = React.PropsWithChildren<{
    ...
    id?: string;
    mortgagee?: any;
    onSubmit?: (fields: MortgageeUpdateFormInputValues) => MortgageeUpdateFormInputValues;
    onSuccess?: (fields: MortgageeUpdateFormInputValues) => void;
    onError?: (fields: MortgageeUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: MortgageeUpdateFormInputValues) => MortgageeUpdateFormInputValues;
    onValidate?: MortgageeUpdateFormValidationValues;
} & React.CSSProperties>;
export default function MortgageeUpdateForm(props: MortgageeUpdateFormProps): React.ReactElement;
