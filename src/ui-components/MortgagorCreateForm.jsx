...
import { createMortgagor } from "../graphql/mutations";
const client = generateClient();
export default function MortgagorCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createMortgagor.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "MortgagorCreateForm")}
      {...rest}
    >
      <TextField
        label="Co reg no"
