...
`;
export const onCreateCitizen = /* GraphQL */ `
  subscription OnCreateCitizen($filter: ModelSubscriptionCitizenFilterInput) {
    onCreateCitizen(filter: $filter) {
      id
      full_name
      surrname
      first_name
...
`;
export const onUpdateCitizen = /* GraphQL */ `
  subscription OnUpdateCitizen($filter: ModelSubscriptionCitizenFilterInput) {
    onUpdateCitizen(filter: $filter) {
      id
      full_name
      surrname
      first_name
...
`;
export const onDeleteCitizen = /* GraphQL */ `
  subscription OnDeleteCitizen($filter: ModelSubscriptionCitizenFilterInput) {
    onDeleteCitizen(filter: $filter) {
      id
      full_name
      surrname
      first_name
